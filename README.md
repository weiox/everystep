# everystep：一步一步写清楚的技术专栏

everystep 是一个长期维护的技术写作项目，围绕 C++、系统与工程实践等主题，用**可以落地的故事、例子和代码**，帮读者把看起来很复杂的东西拆成一小步一小步。

这个仓库收录了 everystep 网站上的专栏与文章原文，欢迎你一起完善、校对、补充。

> **AI 驱动的文档实验**  
> everystep 的大量内容是在与 AI（大语言模型）高频协作下完成的：人类负责设定目标、把关方向和最终文字；AI 帮忙重组知识、设计结构和产出初稿。我们希望借此探索一种新的技术教程形式——让 AI 参与重塑文档结构与表达，同时保留人类作者对准确性、边界和经验的把关。
...
无论在哪种形式下阅读，我们都希望你能比较轻松地“跟着文章往前走”，而不是被堆砌的概念劝退。
